...
\begin{exercise}[Amortisierte Analyse]
	% Algorithms and Data Structures 2 - amortized.pdf
...
\begin{exercise}[Potenzialfunktion: Verdopplung von Arrays]
	% Algorithms and Data Structures 2 - amortized.pdf
...
\begin{exercise}[Implementierung von dynamischen Tabellen]
	% Algorithms and Data Structures 2 - amortized.pdf
...
\begin{exercise}[Deamortisierung von dynamischen Tabellen]
	% Algorithms and Data Structures 2 - amortized.pdf
...
\begin{exercise}[\emoji{star}: Queues mit zwei Stacks]\mbox{}\\
