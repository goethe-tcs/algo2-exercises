...
\begin{aufgabe}[Max-Flow-Min-Cut II]
    % KT 7.2
    Abbildung~\ref{Figure_3} zeigt ein Flussnetzwerk, auf dem ein $s$-$t$-Fluss berechnet wurde. Der Ausdruck $f/c$ in jeder Kante gibt an, wie viel Fluss $f$ über die Kante geschickt wird und welche Kapazizät $c$ die Kante hat. (Über die Kanten ohne Kästchen---im Speziellen die vier Kanten mit Kapazität 3---wird kein Fluss geschickt.)
    \begin{enumerate}
