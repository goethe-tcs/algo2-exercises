...
\
    % KT 7.1
    \begin{enumerate}
        \item Schreibe alle minimalen $s$-$t$-Schnitte im dargestellten Flussnetzwerk aus Abbildung~\ref{Figure_1} auf. Die Kapazität einer Kante steht neben der jeweiligen Kante. \\
        \item Was ist die minimale Kapazität eines $s$-$t$-Schnittes im gegebenen Flussnetzwerk aus Abbildung~\ref{Figure_2}? Die Kapazität einer Kante steht neben der jeweiligen Kante.
    \end{enumerate}
