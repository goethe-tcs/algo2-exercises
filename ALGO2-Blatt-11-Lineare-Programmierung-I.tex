...
\usepackage{algo221}
\uebung{11}{}{}
\blattname{Übungen zu Woche 11: Lineare Programmierung I}
...
\begin{exercise}[Lösungsmenge eines \acsp{LP}]\
...
\begin{exercise}[Single-Source Shortest Path \acs{LP}]
...
\begin{exercise}[Lokal optimale und zulässige Basis]\
...
\begin{exercise}[Initiale Basis für Simplex]
...
\begin{exercise}[\emoji{star}: Carath{\'e}odory's Theorem]
