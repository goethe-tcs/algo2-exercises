...
\begin{exercise}[Mortys Labyrinth I][\atschool\intro]
...
\end{exercise}
\newpage
\begin{exercise}[Organisiert euch][\intro]
  \begin{enumerate}
    ...
    All diese Informationen findest du auf der \href{https://tcs.uni-frankfurt.de/algo2/}{Webseite des Kurses} oder auf der \href{https://moodle.studiumdigitale.uni-frankfurt.de/moodle/course/view.php?id=2241}{Moodle-Seite des Kurses}.
...
% \newpage
\begin{exercise}[APSP-Algorithmen Motivation][\intro]
...
\end{exercise}
  ...
  \begin{exercise}[APSP-Algorithmen anwenden][\intro]
...
\begin{itemize}
  ...
  \item
  Implementiere einen APSP-Algorithmus deiner Wahl in einer Programmiersprache deiner Wahl.
...
\begin{itemize}
  ...
  Wichtig ist, dass dort eure Namen und eure \texttt{@stud.uni-frankfurt.de} E-Mail-Adresse stehen.
  ...
  \item
  Die Abgabe erfolgt dann im Tutorium als ausgedrucktes DIN-A4 Blatt. Drucken könnt ihr kostenlos im RBI-Keller des IfI. In Absprache mit deinem Tutor ist auch eine Abgabe per E-Mail als PDF-Datei denkbar. Eine Abgabe im Plenum oder sonstwo ist nicht möglich.
  \item
