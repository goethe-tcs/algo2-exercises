...
\begin{aufgabe}
  Gegeben sei der gewichtete Graph $G$ in Abbildung~\ref{example_graph}. 
...
%			\node[draw,circle] (v3)  at (12, 3.5)	{$3$};
			...
			\node[draw,circle] (v6)  at (9,1.75)	{$3$};
...
%			\node[draw,circle] (v11) at (12,0)	{$11$};
			%
			\def\list {v0/v1/6, v0/v2/4, v1/v2/1, v1/v4/8, v1/v5/3, %v2/v3/6,
      v2/v6/8, v4/v5/4, v4/v8/5, v8/v9/1, v9/v5/6, v9/v10/4%, v10/v7/7,
      %v10/v11/2
      }  % list elements
			\foreach \u\v\weight in \list
			{	\draw[-Stealth] (\u) -- (\v) node [midway, above] {\weight};
			}
			\def\vertical {v0/v4/3, v2/v5/4, v2/v9/4,% v3/v7/7,
      v6/v10/1%, v11/v7/2
      }  % list elements
      ...
      \path[-Stealth] (v5) edge[bend right] node[above] {2} (v1);
		\end{tikzpicture}
