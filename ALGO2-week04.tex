...
\section*{\emoji{star}-Aufgabe}

Beschreibe, wie man eine Queue implementiert, wenn man zwei Stacks und $\Oh(1)$ zusätzlichen Speicherplatz benutzt, sodass die amortisierte Laufzeit für jede \texttt{enqueue} oder \texttt{dequeue} Operation $\Oh(1)$ beträgt. Der \textit{einzige} Zugriff auf die Stacks erfolgt durch die Standardoperationen \texttt{PUSH} und \texttt{POP}.
